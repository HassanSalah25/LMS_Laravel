            ...
            <div class="col-md-9 personal-info">
                ...
                <form class="yourform" action="store" method="post" autocomplete="off">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <input class="form-control" type="text" placeholder="desription" name="desription" ">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-lg-3 control-label">Cover Image:</label>
                        <div class="col-lg-8">
                            <input class="form-control" type="text" placeholder="Cover Image" name="cover_image" ">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <input class="form-control" type="text" placeholder="Certificate Image" name="certificate_image" ">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <input class="form-control" type="text" placeholder="is Active" name="is_active">
                        </div>
                    </div>
